...
import com.galaxyws.aircraftdemo.view.gl2es2.ActorModelBuilder;
...
public class ShaderTest implements GLEventListener {
	...
	public void init(GLAutoDrawable drawable) {
		try {
			RenderablePBModel model = PBModelLoader
					.loadPBModel(new File(
							"O:\\hippo\\AircraftDemo\\src\\main\\resources\\com\\galaxyws\\aircraftdemo\\dan.pbm"));

			ActorModelBuilder.getInstance().buildTextureRenderableFromPBModel(
					drawable, model);
